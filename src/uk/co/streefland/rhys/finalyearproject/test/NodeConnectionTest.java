...
public class NodeConnectionTest
{
    ...
    public static void main(String[] args)
    {
        try
        {
            ...
            LocalNode kad2 = new LocalNode("Crystal", new NodeId("ASERTKJDHGVHERJHGFLK"), 7572);
...
//            System.out.println(kad2.getNode().getRoutingTable());
            ...
            LocalNode kad3 = new LocalNode("Jessica", new NodeId("ASERTKJDOLKMNBVFR45G"), 7783);
...
//            System.out.println("Kad 3 - Kad 2 distance: " + diff32.getFirstSetBitIndex());
            LocalNode kad4 = new LocalNode("Sandy", new NodeId("ASERTK85OLKMN85FR4SS"), 7789);
