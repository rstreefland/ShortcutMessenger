...
public class Server
{
     ...
     */
    public Server(int udpPort, KademliaMessageFactory mFactory, LocalNode localNode, Configuration config, KadStatistician statistician) throws SocketException
    {
        this.config = config;
