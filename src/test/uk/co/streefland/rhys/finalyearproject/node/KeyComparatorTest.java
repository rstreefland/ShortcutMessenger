...
public class KeyComparatorTest {
    ...
    public void testNodeComparison() throws Exception {
        ...
        Node node1 = new Node(baseKey.generateKeyIdUsingDistance(25), InetAddress.getByName("127.0.0.1"), 123);
        Node node2 = new Node(baseKey.generateKeyIdUsingDistance(9), InetAddress.getByName("127.0.0.1"), 123);
        Node node3 = new Node(baseKey.generateKeyIdUsingDistance(147), InetAddress.getByName("127.0.0.1"), 123);
